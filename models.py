...
class Quant_dwpw(QuantHelper):
    def __init__(self, prod_dw_in_planes, in_planes, out_planes, n_dw_emb, n_pw_emb, n_f_emb, kernel_size=3, stride=1, padding=0, gs=1, decay=0.99, ret_x=False):
        ...
        self.n_fdw_emb = prod_dw_in_planes // 2 if prod_dw_in_planes//2 > self.n_f_emb else self.n_f_emb
        self.n_fpw_emb = prod_dw_in_planes * out_planes // 2 if prod_dw_in_planes * out_planes // 2 > self.n_f_emb else self.n_f_emb
